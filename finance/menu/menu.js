...
model:{
  host:'http://localhost/piawai/api/menu.php',

table:{id:'menu',data:[
{id:1,induk:0,nama:"Masters",isi:1,icon:"setting",url:"menu.controller.menu(1)"},
{id:2,induk:0,nama:"LMS",isi:1,icon:"edu",url:"d.goto('/lms/menu')"},
{id:4,induk:0,nama:"Dashboard",isi:1,icon:"code",url:"d.goto('/piawai/dashboard')"},

{id:6,induk:1,nama:"Dashboards",isi:1,icon:"house",url:"d.url('dashboards')"},
{id:7,induk:1,nama:"Menu",isi:2,icon:"menu",url:"d.url('menu')"},
