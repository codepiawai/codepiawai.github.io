...
controller:{
  view:function(){
  // nenambahkan button materi
   d.model.edit.button.data.push({id:2,nama:"Materi",icon:"x",url:"d.url('materi')"})
...
// d.gebi('content').innerHTML='sertifikat s';
cert=
`
<div class="canvas-wrap">
  <canvas id="canvas" width="1200" height="850"></canvas><br><br>
  <button onclick="sertifikat.generator.downloadPNG()">Download PNG</button>
</div>
`;

d.modal(cert);
sertifikat.generator.preview(0);
},
