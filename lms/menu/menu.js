...
model:{
table:{id:'menu',data:[
  {id:1,induk:0,nama:"Kursus",isi:1,icon:"setting",url:"d.url('kursus')"},
  {id:1,induk:0,nama:"Materi",isi:1,icon:"setting",url:"d.url('materi')"},
{id:2,induk:0,nama:"Forum",isi:1,icon:"edu",url:"menu.controller.menu(2)"},
{id:3,induk:0,nama:"Kuesioner",isi:1,icon:"code",url:"d.goto('/lms/course')"},
{id:3,induk:0,nama:"Jadwal",isi:1,icon:"code",url:"d.goto('/lms/course')"},
...
{id:4,induk:2,nama:"Jadwal",isi:1,icon:"edu",url:"d.url('jadwal')"},
