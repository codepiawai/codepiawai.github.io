...
card:{id:"card", data:[
{id:1,nama:"Course",isi:"15",icon:"edu",url:"d.url('pesan');"},
{id:2,nama:"Instructor",isi:"3",icon:"setting",url:"d.url('exam');"},
{id:2,nama:"Learner",isi:"50",icon:"file",url:"d.url('cert');"},
...
<img id="avatar" class="user-avatar img" src="piawai-logo.jpg"> </div>
</div>
