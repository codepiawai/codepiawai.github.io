...
card:{id:"card", data:[
  {id:1,nama:"Kursus",isi:"3",icon:"edu",url:"d.goto('/lms/kursus?admin')"},
  {id:1,nama:"Materi",isi:"3",icon:"edu",url:"d.goto('/lms/materi?admin')"},
  {id:1,nama:"Kuis",isi:"3",icon:"edu",url:"d.goto('/lms/kuis?admin')"},
  {id:1,nama:"Soal",isi:"3",icon:"edu",url:"d.goto('/lms/soal?admin')"},
