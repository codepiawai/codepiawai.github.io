var soal = {
model:{
  host:'http://localhost/api/lms/soal.php',
  role:'tutor',
  table:{id:'menu',data:[
  ...
  {id:4,induk:1,nama:"Kuis",isi:2,icon:"eye",url:"soal.controller('kuis-web')"},
...
view:{
  view:function(arr){
    let out = `
      ...
      <div id="quizContent" class="row shadow"></div>
      <div class="row shadow gButton">
...
controller:{
  view:function(){
  d.service.host=soal.model.host;
  d.service.param={t:'kuis', mod:'table',nama:'users'};
  ...
  d.controller.view()
    ...
    i = 0;
    d.gebi('content').innerHTML=soal.view(i);
    // ====== STATE & DATA ======
